...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/hexonal/entrox/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for hexonal/entrox...\n")
...
console.log("Fetching npm all-time downloads for entrox...\n")
const npmDownloads = await fetchNpmDownloads("entrox")
