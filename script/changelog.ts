...
Generates UPCOMING_CHANGELOG.md by running the Entrox changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for entrox run (default: low)
      --quiet            Suppress Entrox command output unless it fails
