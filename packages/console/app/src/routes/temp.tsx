    ...
    <main data-page="home">
      ...
      <div data-component="content">
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                npm install -g <strong>{publicBrand.packageName}</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                bun install -g <strong>{publicBrand.packageName}</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          ...
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                paru -S <strong>{publicBrand.command}-bin</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href={publicBrand.xURL}>{i18n.t("footer.x")}</a>
          </div>
          <div data-slot="cell">
            <a href={publicBrand.repositoryURL}>{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href={publicBrand.discordURL}>{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
      ...
      <div data-component="legal">
        <span>
          ©2025 <a href="https://entrox.996icu.wiki">Hexonal</a>
        </span>
      </div>
    </main>
  )
