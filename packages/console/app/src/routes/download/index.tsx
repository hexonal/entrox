...
import desktopAppIcon from "../../asset/lander/entrox-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick(`curl -fsSL ${publicBrand.installURL} | bash`)}
              >
                <code>
                  curl -fsSL https://<strong>{publicBrand.domain}/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick(`npm i -g ${publicBrand.packageName}`)}>
                <code>
                  npm i -g <strong>{publicBrand.packageName}</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick(`bun add -g ${publicBrand.packageName}`)}>
                <code>
                  bun add -g <strong>{publicBrand.packageName}</strong>
                </code>
                <CopyStatus />
              </button>
              ...
              <button data-component="cli-row" onClick={handleCopyClick(`paru -S ${publicBrand.command}`)}>
                <code>
                  paru -S <strong>{publicBrand.command}</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                data-component="cli-row"
                onClick={handleCopyClick(`brew install --cask ${publicBrand.desktopPackageName}`)}
              >
                <code>
                  brew install --cask <strong>{publicBrand.desktopPackageName}</strong>
                </code>
                <CopyStatus />
              </button>
