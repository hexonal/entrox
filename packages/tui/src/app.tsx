...
import { UPDATE_AVAILABLE_VERSION_KEY, UPDATE_SKIPPED_VERSION_KEY, updateNoticeVersion } from "./update-notice"
...
function App(props: { onSnapshot?: () => Promise<string[]>; pluginHost: TuiPluginHost }) {
  ...
  event.on("installation.update-available", async (evt) => {
    ...
    if (noticeVersion) kv.set(UPDATE_AVAILABLE_VERSION_KEY, noticeVersion)
    ...
    if (choice === false) {
      kv.set(UPDATE_SKIPPED_VERSION_KEY, version)
      return
    }
    ...
    await DialogAlert.show(
      dialog,
      "Update Complete",
      `Successfully updated to ${Brand.product} v${result.data.version}. Please restart the application.`,
    )
