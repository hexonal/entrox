...
const en = {
  "app.title": "AI Model Usage Rankings | Entrox Data",
  "app.description":
    "Explore Entrox Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Entrox Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Entrox on GitHub",
  "header.github": "GitHub",
  "header.tryEntrox": "Try Entrox",
  ...
  "home.topModelsDescription": "Usage of models across Entrox Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Entrox Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Entrox Data",
  "lab.description":
    "Compare {{lab}} models used in Entrox Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Entrox usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Entrox",
  ...
  "lab.shareOfUsage": "{{share}} of recent Entrox usage",
  "lab.usageTitle": "{{lab}} token usage",
  "lab.usageDescription": "Daily Entrox token volume over the last two months.",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Entrox Data",
  "model.description":
    "View {{model}} Entrox Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Entrox Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Entrox Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Entrox Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Entrox Go usage in the current data window.",
  ...
  "model.inputs": "Inputs",
  "model.overviewDescription": "Recent Entrox Go tokens, unique users, and market position.",
  "model.noSummaryTitle": "No usage summary",
  "model.noSummaryDescription": "This model has no Entrox Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily Entrox Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique Entrox Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average Entrox Go session shape.",
  ...
  "model.geoDescription": "Entrox Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Entrox Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Entrox Go token volume.",
