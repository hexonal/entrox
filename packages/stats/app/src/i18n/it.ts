export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Entrox Data",
  "app.description":
    "Esplora l'utilizzo di Entrox Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Entrox Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Entrox su GitHub",
  "header.github": "GitHub",
  "header.tryEntrox": "Prova Entrox",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Entrox Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Entrox Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Entrox Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Entrox Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Entrox.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Entrox",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Entrox",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Entrox negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Entrox Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Entrox Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Entrox Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Entrox Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Entrox Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Entrox Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Entrox Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Entrox Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Entrox Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Entrox Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Entrox Go.",
  ...
  "model.geoDescription": "Token del modello Entrox Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica Entrox Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token Entrox Go.",
