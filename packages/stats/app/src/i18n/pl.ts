export const dict = {
  "app.title": "Rankingi użycia modeli AI | Entrox Data",
  "app.description":
    "Przeglądaj użycie Entrox Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Entrox Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Entrox na GitHub",
  "header.github": "GitHub",
  "header.tryEntrox": "Wypróbuj Entrox",
  ...
  "footer.homeAria": "Strona główna Entrox",
  ...
  "home.topModelsDescription": "Użycie modeli w Entrox Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Entrox Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Entrox Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Entrox Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Entrox.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Entrox",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Entrox",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Entrox z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Entrox Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Entrox Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Entrox Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Entrox Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Entrox Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Entrox Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Entrox Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Entrox Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Entrox Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Entrox Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Entrox Go.",
  ...
  "model.geoDescription": "Tokeny modelu Entrox Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Entrox Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Entrox Go.",
