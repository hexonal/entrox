export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Entrox Data",
  "app.description":
    "Explore o uso do Entrox Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Entrox Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Entrox no GitHub",
  "header.github": "GitHub",
  "header.tryEntrox": "Experimente o Entrox",
  ...
  "footer.homeAria": "Início do Entrox",
  ...
  "modal.title": "Newsletter do Entrox",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Entrox Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Entrox Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Entrox Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Entrox Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Entrox.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Entrox",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Entrox",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Entrox nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Entrox Data",
  "model.description":
    "Veja dados de uso de {{model}} no Entrox Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Entrox Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Entrox Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Entrox Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Entrox Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Entrox Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Entrox Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Entrox Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Entrox Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Entrox Go.",
  ...
  "model.geoDescription": "Tokens do modelo Entrox Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do Entrox Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Entrox Go.",
