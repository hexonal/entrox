      ...
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://entrox.996icu.wiki/">
            <strong>{i18n.t("header.tryEntrox")}</strong>
          </a>
          <button
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://entrox.996icu.wiki/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://entrox.996icu.wiki/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:w741069229@gmail.com", label: i18n.t("footer.contact") },
    { href: "https://entrox.996icu.wiki/discord", label: i18n.t("footer.community") },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://entrox.996icu.wiki" aria-label={i18n.t("footer.homeAria")}>
          <EntroxMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={opencodeWordmarkDark} alt="Entrox" />
          <button
