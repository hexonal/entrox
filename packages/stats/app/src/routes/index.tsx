...
const statsHomeDescription =
  "Explore Entrox usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns."
  ...
  return (
    <section id="top-models" data-section="top-models">
      <h2 data-slot="top-models-title">
        <strong>Top models.</strong> <span>Usage of models across Entrox Go.</span>
      </h2>
      <Show
...
function UniqueUsersSection(props: { data: StatsHomeData["users"] }) {
  ...
  return (
    <section id="unique-users" data-section="unique-users">
      ...
      <SectionTitle title="Unique Users" description="Daily unique Entrox Go users by model." />
      <Show
        when={data().some((item) => usageTotal(item) > 0)}
        fallback={
