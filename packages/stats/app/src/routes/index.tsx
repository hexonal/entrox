...
import entroxWordmarkDark from "../asset/logo-ornate-dark.svg"
import {
  getStatsHomeData,
...
const statsHomeTitle = "Entrox Stats"
const statsHomeDescription = "Entrox usage, market share, token cost, and session cost stats."
const statsHomeFallbackUrl = "https://stats.entrox.996icu.wiki"
const statsUnfurlPath = "banner.png"
const statsUnfurlAlt = "Entrox Stats wordmark on a dark patterned background"
const headerLinks = [
...
const githubLink = {
  href: "https://github.com/hexonal/entrox",
  apiHref: "https://api.github.com/repos/hexonal/entrox",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star Entrox on GitHub",
}
...
const themeStorageKey = "entrox:stats-theme"
...
export default function StatsHome() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="Entrox" />
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.opencode.ai") return statsHomeFallbackUrl
  if (url.hostname === "stats.dev.opencode.ai") return statsHomeFallbackUrl
  return url.toString()
}
  ...
  return (
      <section id="top-models" data-section="top-models">
        <h2 data-slot="top-models-title">
          <strong>Top models.</strong> <span>Usage of models across Entrox.</span>
        </h2>
      <Show
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://entrox.996icu.wiki/">
            <strong>Try Entrox</strong>
          </a>
          <button
...
function EntroxMark() {
  return (
    <svg data-slot="entrox-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
function Footer(props: {
  ...
  const legal = [
    { href: "https://entrox.996icu.wiki/legal/terms-of-service", label: "Terms of service" },
    { href: "https://entrox.996icu.wiki/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:w741069229@gmail.com", label: "Contact us" },
    { href: "https://entrox.996icu.wiki/discord", label: "Community" },
    githubLink,
    { href: "https://entrox.996icu.wiki", label: "Website" },
  ]
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://entrox.996icu.wiki" aria-label="Entrox home">
          <EntroxMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={entroxWordmarkDark} alt="Entrox" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">Entrox Newsletter</h2>
            <p>
