...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServerV1.Server).annotate({
    description: `Server configuration for ${ProviderBrand.command} serve and web commands`,
  }),
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: `Command configuration, see ${ProviderBrand.docsURL}/commands`,
  }),
  ...
  review_model: Schema.optional(Schema.String).annotate({
    description: "Model to use for the built-in /review command in the format of provider/model",
  }),
  ...
  ).annotate({ description: `Agent configuration, see ${ProviderBrand.docsURL}/agents` }),
