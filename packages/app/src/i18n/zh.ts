...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 Entrox 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "Entrox 提供的免费模型",
  ...
  "provider.connect.opencodeZen.line1": "Entrox 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.opencodeZen.visit.link": "Entrox",
