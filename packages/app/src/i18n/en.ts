export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Entrox",
  ...
  "provider.connect.opencodeZen.line1":
    "Entrox gives you access to a curated set of reliable optimized models for coding agents.",
