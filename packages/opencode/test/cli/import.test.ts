...
test("parses valid share URLs", () => {
  expect(parseShareUrl(`${Brand.shareBaseURL}/share/Jsj3hNIW`)).toBe("Jsj3hNIW")
  expect(parseShareUrl(`${Brand.shareBaseURL}/s/Jsj3hNIW`)).toBe("Jsj3hNIW")
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl(`${Brand.shareBaseURL}/share/`)).toBeNull()
  expect(parseShareUrl(`${Brand.shareBaseURL}/s/`)).toBeNull()
  expect(parseShareUrl(`${Brand.shareBaseURL}/share/id/extra`)).toBeNull()
