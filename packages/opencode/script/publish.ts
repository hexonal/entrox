...
const homebrewTapRepo = process.env.HOMEBREW_TAP_REPO ?? "hexonal/homebrew-tap"
...
if (!Script.preview) {
  ...
  await Bun.file(`./dist/homebrew-tap/${binaryName}.rb`).write(homebrewFormula)
  await $`cd ./dist/homebrew-tap && git add ${binaryName}.rb`
