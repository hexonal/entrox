  ...
  return {
      ...
      Effect.succeed({
        ...
        options: {
          headers: {
            ...
            "X-Source": Brand.userAgentProduct,
          },
        },
      }),
    openrouter: () =>
    ...
    gitlab: Effect.fnUntraced(function* (input: Info) {
      ...
      const aiGatewayHeaders = {
        "User-Agent": `${brandUserAgent(InstallationVersion, `gitlab-ai-provider/${GITLAB_PROVIDER_VERSION}`)} (${os.platform()} ${os.release()}; ${os.arch()})`,
    ...
    "cloudflare-workers-ai": Effect.fnUntraced(function* (input: Info) {
      ...
      return {
        ...
        options: {
          apiKey,
          headers: {
            "User-Agent": `${brandUserAgent(InstallationVersion, "cloudflare-workers-ai")} (${os.platform()} ${os.release()}; ${os.arch()})`,
          },
        },
        async getModel(sdk: any, modelID: string) {
          return sdk.languageModel(modelID)
    ...
    "cloudflare-ai-gateway": Effect.fnUntraced(function* (input: Info) {
      ...
      const opts = {
        ...
        headers: {
          "User-Agent": `${brandUserAgent(InstallationVersion, "cloudflare-ai-gateway")} (${os.platform()} ${os.release()}; ${os.arch()})`,
        },
      }
    ...
    cerebras: () =>
      Effect.succeed({
        ...
        options: {
          headers: {
            "X-Cerebras-3rd-Party-Integration": Brand.userAgentProduct,
          },
        },
      }),
    kilo: () =>
