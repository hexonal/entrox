...
<html>
<head>
  <title>${Brand.display} - Authorization Successful</title>
  <style>
...
<body>
  <div class="container">
    ...
    <p>You can close this window and return to ${Brand.display}.</p>
  </div>
...
<html>
<head>
  <title>${Brand.display} - Authorization Failed</title>
  <style>
    body { font-family: system-ui, -apple-system, sans-serif; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; background: #1a1a2e; color: #eee; }
    .container { text-align: center; padding: 2rem; }
