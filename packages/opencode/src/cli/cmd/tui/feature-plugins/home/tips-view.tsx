...
const TIPS: Tip[] = [
  ...
  `Create {highlight}${Brand.configBase}.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings`,
  `Place TUI settings in {highlight}~/.config/${Brand.configBase}/tui.json{/highlight} for global config`,
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  `Add {highlight}.md{/highlight} files to {highlight}${Brand.projectDirectory}/commands/{/highlight} to define reusable custom prompts`,
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  `Add {highlight}.md{/highlight} files to {highlight}${Brand.projectDirectory}/agents/{/highlight} for specialized AI personas`,
  ...
  `Create {highlight}.ts{/highlight} files in {highlight}${Brand.projectDirectory}/tools/{/highlight} to define new LLM tools`,
  "Tool definitions can invoke scripts written in Python, Go, etc",
  `Add {highlight}.ts{/highlight} files to {highlight}${Brand.projectDirectory}/plugins/{/highlight} for event hooks`,
  ...
  "Use {highlight}/connect{/highlight} for curated, tested models",
